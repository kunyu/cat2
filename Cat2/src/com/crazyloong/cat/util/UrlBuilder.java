...
public class UrlBuilder {
     ...
     * 构造器
     */
    public UrlBuilder(PostBody postBody) {
        this(postBody.getHost(), 80, null);
        this.paths = new String[]{postBody.getAPI()};
    }

    /**
     * 构造器
     */
    public UrlBuilder(GetBody getBody) {
        this(getBody.getHost(), 80, null);
        this.parameters = getBody.getParamters();
        this.paths = new String[]{getBody.getAPI()};
    }
    ...
    public String toString(String encoding) {
        ...
        // 写入参数字符串
        if (ObjectUtil.isParametersExsit(parameters)) {
            s.append("?");
